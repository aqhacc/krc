...
class Kuramoto:
    ...
    def derivative(self, t, angles_vec, adj_mat, coupling):
        '''
    ...
    def integrate(self, angles_vec, adj_mat):
        ...
        sol = solve_ivp(self.derivative, (t_eval[0], t_eval[-1]), angles_vec, t_eval=t_eval, args=(adj_mat, coupling), method='LSODA')
